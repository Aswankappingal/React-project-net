         ...
         <div className="conact-us">
              ...
              <div className="map-section-main">
                <div className="map-section-map">
                  ...
                  <h3>Contact US</h3>
                  <span><i class="fa fa-map-marker" id='logo' aria-hidden="true"></i></span>
                  <span>Address</span>
                  <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorem natus qui animi</p>

                  <span><i class="fa fa-phone-square" id='logo' aria-hidden="true"></i></span>
                  <span>Phone</span>
                  <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit.+91 9656562371</p>

                  <span><i class="fa fa-envelope"  id='logo' aria-hidden="true"></i></span>
                  <span>Email</span>
